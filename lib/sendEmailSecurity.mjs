...
export const CONSULTANT_EMAIL_MAP = {
  ...
  christine_reich: 'christine@capitalmotorcars.com',
...
/** Team addresses CC'd on every credit-application email. */
...
/** Team addresses CC'd on contact/trade-in lead emails (no sales@, no info@). */
export const CONTACT_CC_EMAILS = ['kai@capitalmotorcars.com'];
