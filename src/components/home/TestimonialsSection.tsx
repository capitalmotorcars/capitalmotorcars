    ...
    <section className="py-16 lg:py-20  ">
      <div ref={ref} className={cn('scroll-reveal', isRevealed && 'revealed')}>
        ...
        <div className="relative flex w-full max-w-[100rem] items-center justify-center overflow-hidden mx-auto px-4 lg:px-8">
          ...
          {/* Final corrected shadows: light mode (white), dark mode (hsl(0,0%,4%)) */}
          <div className="pointer-events-none absolute inset-y-0 left-0 w-32 md:w-48 bg-gradient-to-r from-white dark:from-black/[0.02] to-transparent z-[1]" />
          <div className="pointer-events-none absolute inset-y-0 right-0 w-32 md:w-48 bg-gradient-to-l from-white dark:from-black/[0.02] to-transparent z-[1]" />
        </div>
      </div>
    </section>
  );
