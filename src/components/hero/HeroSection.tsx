      ...
      <div className="relative container mx-auto px-4 lg:px-8">
        <div className="flex flex-col lg:flex-row lg:items-start lg:gap-12 xl:gap-20">
          ...
          <div className="max-w-xl flex-shrink-0 z-10 lg:py-12">
            {/* Social Proof Badges - DESKTOP ONLY (above headline) */}
            <div
              className={`hidden lg:flex flex-wrap items-center gap-3 mb-6 hero-animate ${
            ...
            <h1
              className={`text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-4 lg:mb-6 leading-[1.1] hero-animate ${
                heroAnimated ? 'animate-in' : ''
              }`}
            >
            ...
            {/* Social Proof Badges - MOBILE ONLY (below headline) */}
            <div
              className={`flex lg:hidden flex-wrap items-center gap-2 mb-4 hero-animate ${
                heroAnimated ? 'animate-in' : ''
              }`}
            >
              {/* Avatars + Customer Count */}
