...
import { HorizontalProcessVisualization } from './HorizontalProcessVisualization';
...
export function HeroSection() {
  ...
  return (
    <section className="relative pt-12 pb-16 lg:pt-20 lg:pb-24 min-h-[700px] lg:min-h-[800px]" style={{ backgroundColor: 'hsl(216 27% 6%)' }}>
      ...
      <div className="relative container mx-auto px-4 lg:px-8">
        ...
        <div className="flex flex-col items-center text-center max-w-4xl mx-auto">
          ...
          <a
            ...
            className={`flex flex-wrap items-center justify-center gap-2 lg:gap-3 mb-5 lg:mb-6 hero-animate cursor-pointer hover:opacity-80 transition-opacity ${
              heroAnimated ? 'animate-in' : ''
            }`}
          >
          ...
          <p
            className={`text-lg md:text-xl mb-8 leading-relaxed max-w-2xl mx-auto hero-animate delay-1 ${
              heroAnimated ? 'animate-in' : ''
            }`}
          ...
          <div
            className={`flex flex-col sm:flex-row items-center justify-center gap-4 hero-animate delay-2 ${
              heroAnimated ? 'animate-in' : ''
            }`}
          >
            <Button
        ...
        <div
          className={`mt-12 lg:mt-16 w-full max-w-5xl mx-auto hero-animate delay-3 ${heroAnimated ? 'animate-in' : ''}`}
        >
