      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 xl:px-12 pt-16 md:pt-20 lg:pt-24 xl:pt-28 flex-1 flex flex-col min-h-0 items-center justify-center" style={{ position: 'relative', transform: 'translate3d(0, 0, 0)', willChange: 'auto' }}>
        <div className="w-full max-w-7xl xl:max-w-[90rem] mx-auto flex flex-col items-center gap-10 md:gap-12 xl:gap-10 pt-0 md:pt-14" style={{ position: 'relative', transform: 'translate3d(0, 0, 0)', willChange: 'auto' }}>
              ...
              <div className={`flex flex-row items-center gap-3 xl:gap-4 w-full sm:w-auto hero-animate delay-2 ${animate}`}>
                ...
                <MagneticButton strength={0.35} className="w-full sm:w-auto min-w-0">
                  <Button
                    ...
                    variant="ghost"
                    size="lg"
                    className="w-full sm:w-auto h-11 sm:h-12 xl:h-14 rounded-lg xl:rounded-xl border border-white/50 hover:border-white/80 hover:text-white/80 bg-white/20 dark:bg-white/[0.06] text-white/90 dark:text-white/90 hover:bg-white/15 dark:hover:bg-white/10 font-medium xl:font-semibold px-6 xl:px-10 text-sm sm:text-base xl:text-lg shadow-md shadow-black/5 dark:shadow-black/20 backdrop-blur-sm hover:shadow-lg hover:shadow-black/10 dark:hover:shadow-black/30"
                  >
                    <Link to="/services" className="flex items-center gap-2 xl:gap-3">
                      Explore services
                      <SearchCheckIcon className=" w-4 h-4 xl:w-5 xl:h-5" />
                    </Link>
                  </Button>
                </MagneticButton>
              </div>
          ...
          <div className="w-full flex flex-col items-center gap-0">
            <span className="uppercase tracking-[0.18em] font-medium text-xs  md:text-md xl:text-lg text-white/60">
              Trusted by famous brands
            </span>
            <div className="relative w-full [mask-image:linear-gradient(to_right,transparent_0%,black_8%,black_92%,transparent_100%)] [-webkit-mask-image:linear-gradient(to_right,transparent_0%,black_8%,black_92%,transparent_100%)] [mask-size:100%_100%] [mask-repeat:no-repeat]">
              <style>{`
