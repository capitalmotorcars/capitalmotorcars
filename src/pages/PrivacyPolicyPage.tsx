    ...
    <Layout>
      ...
      <section className="py-8 md:py-16 bg-background">
        <div className="container mx-auto px-4 lg:px-8 max-w-3xl prose prose-gray prose-sm sm:prose-base">
          ...
          <h2 className="text-xl font-bold text-primary mt-10">Media</h2>
          <p className="text-muted-foreground">
            If you upload images to the website, you should avoid uploading images with embedded location data (EXIF GPS) included. Visitors to the website can download and extract any location data from images on the website.
          </p>

          <h2 className="text-xl font-bold text-primary mt-10">Cookies</h2>
          <p className="text-muted-foreground">
          ...
          <h2 className="text-xl font-bold text-primary mt-10">Embedded content from other websites</h2>
          <p className="text-muted-foreground">
          ...
          <h2 className="text-xl font-bold text-primary mt-10">Who we share your data with</h2>
          <p className="text-muted-foreground">
            If you request a password reset, your IP address will be included in the reset email.
          </p>

          <h2 className="text-xl font-bold text-primary mt-10">How long we retain your data</h2>
          <p className="text-muted-foreground">
          ...
          <h2 className="text-xl font-bold text-primary mt-10">What rights you have over your data</h2>
          <p className="text-muted-foreground">
            If you have an account on this site, or have left comments, you can request to receive an exported file of the personal data we hold about you, including any data you have provided to us. You can also request that we erase any personal data we hold about you. This does not include any data we are obliged to keep for administrative, legal, or security purposes.
          </p>

          <h2 className="text-xl font-bold text-primary mt-10">Where we send your data</h2>
          <p className="text-muted-foreground">
          ...
          <h2 className="text-xl font-bold text-primary mt-10">Consent to Receive SMS/MMS Notifications</h2>
          <p className="text-muted-foreground">
          ...
          <h2 className="text-xl font-bold text-primary mt-10">Privacy Policy</h2>
          <p className="text-muted-foreground">
