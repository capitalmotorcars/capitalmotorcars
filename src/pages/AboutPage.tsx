        ...
        <div id="about" className="relative h-full flex flex-col">
          ...
          <div className="absolute top-0 left-0 right-0 h-[30vh] md:h-[45vh] overflow-hidden">
            <img
              src={bg1}
              alt=""
              className="w-full h-full object-cover object-center blur-sm transition-opacity duration-1000"
              aria-hidden
            />
          </div>
          ...
          <div ref={headerRef} className={cn('relative  z-10 flex-1 flex flex-col', 'scroll-reveal', headerRevealed && 'revealed')}>
            ...
            <img src={aboutImage} alt="About Capital Motor Cars" className="w-16 h-16 md:w-28 md:h-28 object-cover object-center " />
